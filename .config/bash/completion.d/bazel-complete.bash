...
--curses={yes,no,auto}
--debug_depset_depth
--nodebug_depset_depth
--dump=
--enable_platform_specific_config
--noenable_platform_specific_config
--experimental_action_args
--noexperimental_action_args
--experimental_allow_incremental_repository_updates
--noexperimental_allow_incremental_repository_updates
...
--noexperimental_aspect_output_propagation
...
--noexperimental_post_profile_started_event
--experimental_profile_action_counts
--noexperimental_profile_action_counts
...
--noexperimental_slim_json_profile
...
--noexperimental_starlark_unused_inputs_list
...
--noincompatible_disable_deprecated_attr_params
...
--noincompatible_enable_profile_by_default
...
--noincompatible_no_output_attr_default
...
--noincompatible_no_target_output_group
--incompatible_remap_main_repo
--noincompatible_remap_main_repo
--incompatible_remove_binary_profile
--noincompatible_remove_binary_profile
--incompatible_remove_enabled_toolchain_types
--noincompatible_remove_enabled_toolchain_types
--incompatible_restrict_named_params
--noincompatible_restrict_named_params
...
--noincompatible_tls_enabled_removed
...
--experimental_inmemory_unused_inputs_list
--noexperimental_inmemory_unused_inputs_list
...
--force_pic
--noforce_pic
--force_python={py2,py3,py2and3,py2only,py3only,_internal_sentinel}
--genrule_strategy=
--google_auth_scopes=
--google_credentials=
--google_default_credentials
...
--noincompatible_allow_python_version_transitions
--incompatible_always_check_depset_elements
--noincompatible_always_check_depset_elements
--incompatible_bzl_disallow_load_after_statement
--noincompatible_bzl_disallow_load_after_statement
...
--noincompatible_remove_old_python_version_api
...
--noincompatible_strict_objc_module_maps
--incompatible_symlinked_sandbox_expands_tree_artifacts_in_runfiles_tree
--noincompatible_symlinked_sandbox_expands_tree_artifacts_in_runfiles_tree
--incompatible_tls_enabled_removed
--noincompatible_tls_enabled_removed
--incompatible_use_cc_configure_from_rules_cc
--noincompatible_use_cc_configure_from_rules_cc
